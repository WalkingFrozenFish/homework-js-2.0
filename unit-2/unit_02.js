...
function t8() {
    let val = document.querySelector(".input-8");
...
function t9() {
    let val_9 = document.querySelector(".i-9");
    let out_9 = document.querySelector(".out-9");
    out_9.textContent= val_9.value;
    val_9.value = "";
...
function t10() {
    ...
    out_10.textContent = input_10 * 10;
}
...
function t11() {
    let input_11 = +document.querySelector(".i-11").value;
    let out_11 = document.querySelector(".out-11");
    out_11.textContent = input_11 + 10;
}
...
function t12() {
    let input_12_1 = document.querySelector(".i-12_1").value;
    let input_12_2 = document.querySelector(".i-12_2").value;
    let out_12 = document.querySelector(".out-12");
    out_12.textContent = "Hello " + input_12_1 + " " + input_12_2;
}
...
function t13() {
    let input_13_1 = +document.querySelector(".i-13_1").value;
    let input_13_2 = +document.querySelector(".i-13_2").value;
    let out_13 = document.querySelector(".out-13");
    out_13.textContent = input_13_1 + input_13_2;
}
...
function t16() {
    let inp_1 = +document.querySelector(".i-16-1").value;
    let inp_2 = +document.querySelector(".i-16-2").value;
    let out_16 = document.querySelector(".out-16");
    out_16.textContent = inp_1 + inp_2;
}
...
function t19() {
    let inp_1 = +document.querySelector(".i-19-1").value;
    // let inp_2 = +document.querySelector(".i-19-2").value;

    // let inp_1 = parseInt(document.querySelector(".i-19-1").value);
    let inp_2 = parseInt(document.querySelector(".i-19-2").value);

    let out_19 = document.querySelector(".out-19");
    out_19.textContent = inp_1 + inp_2;
}
...
function t20() {
    ...
    out_20.textContent = "Уважаемый " + name + ", " + lastName + ", ваш возраст " + age + " года, по профессии вы " + job;
}
