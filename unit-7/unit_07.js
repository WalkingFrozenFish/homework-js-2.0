...
function t6(a, b) {
    return Math.round(Math.random(a, b) * (b - a + 1));
}
...
function t7() {
    ...
    // Способ 2
    // let x = Math.round(Math.random(0, 255) * (255 - 0 + 1));
    // let y = Math.round(Math.random(0, 255) * (255 - 0 + 1));
    // let z = Math.round(Math.random(0, 255) * (255 - 0 + 1));
...
document.querySelector('.b-10').onclick = function () {
    document.querySelector('.out-10').textContent = t10(3, 4);
}
