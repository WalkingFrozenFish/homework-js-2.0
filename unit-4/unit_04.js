...
function f8() {
    ...
    out1.innerHTML += "<input class='i-81'>";
    out1.innerHTML += "<button class='b-81'>Ok</button>";
...
function f14() {
    ...
    document.querySelector(".out-14").textContent = textArea;
}
...
function f19() {
    ...
    let pass = document.querySelector(".i-192").value;
