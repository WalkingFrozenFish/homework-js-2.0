...
console.log(08); // Синий цвет, цвет чисел
console.log("Август"); // Черный цвет, цвет строк
...
document.querySelector(".four").innerHTML = "<h4>Some text 2.</h4>";
document.querySelector(".four").innerHTML += "<p>Some paragraph and some text in paragraph</p>"
...
a.innerHTML = 3.1415; // Через точку пишут дроби
...
let z1 = 6;
let z2 = 3;
let out_14 = document.querySelector(".out-14").innerHTML = z1 * z2;

// Task 15.
// Создайте две переменных y1 = 6, y2 = 3. Создайте div, класс присвойте самостоятельно, выведите в него деление y1 на y2.
let y1 = 6;
let y2 = 3;
let out_15 = document.querySelector(".out-15").innerHTML = y1 / y2;
...
let x1 = "Hello";
let x2 = 5;
let out_16 = document.querySelector(".out-16").innerHTML = x1 + x2;
...
// document.querySelector("body").innerHTML = ""; // Затер документ
